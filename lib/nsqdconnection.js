...
NSQDConnection = (function(_super) {
  ...
  NSQDConnection.prototype.startTLS = function(callback) {
    var ca, cert, event, key, options, tlsConn, tlsVerification, _i, _len, _ref1, _ref2,
      _this = this;
    ...
    _ref2 = this.config, ca = _ref2.ca, key = _ref2.key, cert = _ref2.cert, tlsVerification = _ref2.tlsVerification;
    options = {
      socket: this.conn,
