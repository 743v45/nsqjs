...
NSQDConnection = (function(superClass) {
  ...
  NSQDConnection.prototype.registerStreamListeners = function(conn) {
    ...
    conn.on('close', (function(_this) {
      return function(err) {
        return _this.statemachine.raise('close');
      };
    })(this));
    return conn.setTimeout(this.config.idleTimeout, (function(_this) {
      return function() {
        return _this.statemachine.raise('close');
      };
    })(this));
  ...
  NSQDConnection.prototype.startTLS = function(callback) {
    var ca, cert, event, i, key, len, options, ref1, ref2, tlsConn, tlsVerification;
    ref1 = ['data', 'error', 'close'];
    for (i = 0, len = ref1.length; i < len; i++) {
      event = ref1[i];
      this.conn.removeAllListeners(event);
    }
    ref2 = this.config, ca = ref2.ca, key = ref2.key, cert = ref2.cert, tlsVerification = ref2.tlsVerification;
    options = {
      socket: this.conn,
